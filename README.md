 ...
 **Maintenance of Naval Propulsion Plants** <br> Gas turbine process data for component decay state prediction.| 2016 | Signal | 16 | R | 11.934 |  | Synthetic | Non-Standard | ? | [Link](http://archive.ics.uci.edu/ml/datasets/Condition+Based+Maintenance+of+Naval+Propulsion+Plants)
